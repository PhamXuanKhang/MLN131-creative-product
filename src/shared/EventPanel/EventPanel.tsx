 ...
 * này (mount một lần trong MuseumShell qua ?event=<slug>).
 * Tuần 1: cấu trúc + paper reveal GSAP; typing effect stub (enableTyping)
 * và gallery polish thuộc tuần 2.
 */
...
interface EventPanelProps {
  ...
  onClose: () => void
  /** Typing text — polish tuần 2, mặc định tắt */
