...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    id: 2,
    question:
      "Mặt trận Dân tộc Giải phóng miền Nam Việt Nam được thành lập vào ngày nào?",
  ...
  },
  {
    id: 7,
    question:
      "Hiệp định Paris được ký kết vào ngày nào, buộc Mỹ rút quân khỏi miền Nam?",
  ...
  },
  {
    id: 9,
    question:
      "Cuộc rút chạy hỗn loạn của quân VNCH trên Đường 7B diễn ra sau sự kiện nào?",
    options: [
      "Mất Huế",
      "Mất Buôn Ma Thuột",
      "Mất Đà Nẵng",
  ...
  },
  {
    id: 10,
    question:
      "Trận Xuân Lộc được gọi là gì trong hệ thống phòng thủ Sài Gòn?",
    options: [
      "'Lá chắn thép'",
      "'Cánh cửa thép'",
      "'Bức tường thép'",
  ...
  },
  {
    id: 12,
    question:
      "Tổng thống VNCH nào tuyên bố đầu hàng vô điều kiện ngày 30/4/1975?",
    options: [
      "Nguyễn Văn Thiệu",
      "Trần Văn Hương",
      "Dương Văn Minh",
  ...
  },
  {
    id: 13,
    question:
      "Chiến dịch Hồ Chí Minh tiến vào Sài Gòn bằng bao nhiêu cánh quân?",
  ...
  },
  {
    id: 14,
    question:
      "Ai là người lãnh đạo cuộc khởi nghĩa Mỏ Cày (Bến Tre) năm 1960?",
    options: [
      "Bà Nguyễn Thị Định",
      "Bà Nguyễn Thị Bình",
      "Ông Võ Văn Kiệt",
  ...
  },
  {
    id: 15,
    question:
      "Chiến dịch Xuân - Hè 1972 mở bao nhiêu hướng tiến công đồng thời?",
